    ...
    match target, subtarget:
        ...
        case "glows", "l3b":
            subprocess.run([sys.executable, 'imap_l3_data_processor.py', '--instrument', 'glows', '--data-level', 'l3b',
                            '--start-date', '20100306', '--version', 'v030',
                            '--descriptor', 'ion-rate-profile',
                            '--dependency',
                            '['
                            '{"type": "repoint", "files": ["imap_2026_269_05.repoint.csv"]},'
                            '{"type": "science", "files": ["imap_glows_l3a_hist_20100306-repoint00065_v008.cdf"]},'
                            '{"type": "ancillary", "files":["imap_glows_bad-days-list_20100101_v004.dat"]},'
                            '{"type": "ancillary", "files":["imap_glows_WawHelioIonMP_20100101_v003.json"]},'
                            '{"type": "ancillary", "files":["imap_glows_uv-anisotropy-1CR_20100101_v004.json"]},'
                            '{"type": "ancillary", "files":["imap_glows_pipeline-settings-l3bcde_20100101_v007.json"]}]'])
