...
from imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies import \
    CodiceLoL3b3dDistributionsDependencies, MASS_SPECIES_BIN_LOOKUP_DESCRIPTOR, GEOMETRIC_FACTOR_LOOKUP_DESCRIPTOR, \
...
class TestCodiceLoL3b3dDistributions(unittest.TestCase):
    ...
    @patch(
        "imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies.imap_data_access.download")
    @patch(
        "imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies.CodiceLoL3b3dDistributionsDependencies.from_file_paths")
    def _test_fetch_dependencies(self, species: str, mock_3d_distribution_deps_from_file_paths,
        ...
        CodiceLoL3b3dDistributionsDependencies.fetch_dependencies(processing_input_collection, species)
    ...
    @patch('imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies.EfficiencyLookup.read_from_csv')
    @patch(
        'imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies.GeometricFactorLookup.read_from_csv')
    @patch(
        'imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies.MassSpeciesBinLookup.read_from_csv')
    @patch(
        'imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies.CodiceLoDirectEventData.read_from_cdf')
    @patch('imap_l3_processing.codice.l3.lo.codice_lo_l3b_3d_distributions_dependencies.EnergyLookup.read_from_csv')
    def test_from_file_paths(self, mock_energy_lookup_from_csv, mock_l3a_direct_event_read_from_cdf,
        ...
        actual = CodiceLoL3b3dDistributionsDependencies.from_file_paths(
        ...
        expected_dependencies = CodiceLoL3b3dDistributionsDependencies(
