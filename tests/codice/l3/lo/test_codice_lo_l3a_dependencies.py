...
from imap_l3_processing.codice.l3.lo.codice_lo_l3a_dependencies import CodiceLoL3aDependencies, SW_SPECIES_DESCRIPTOR, \
    MASS_PER_CHARGE_DESCRIPTOR, DIRECT_EVENTS_DESCRIPTOR, MASS_COEFFICIENT_DESCRIPTOR, \
    NSW_PRIORITY_DESCRIPTOR, SW_PRIORITY_DESCRIPTOR
...
class TestCodiceLoL3aDependencies(unittest.TestCase):
    ...
    def test_fetch_dependencies(self, mock_from_file_paths, mock_utils_download):
        ...
        codice_lo_sw_priority_input_file_name = f"imap_codice_l1a_{SW_PRIORITY_DESCRIPTOR}_20100105_v010.cdf"
        codice_lo_nsw_priority_input_file_name = f"imap_codice_l1a_{NSW_PRIORITY_DESCRIPTOR}_20100105_v010.cdf"
        ...
        sw_priority_science_input = ScienceInput(codice_lo_sw_priority_input_file_name)
        nsw_priority_science_input = ScienceInput(codice_lo_nsw_priority_input_file_name)
        ...
        processing_input_collection.add(
            [sectored_science_input, sw_priority_science_input,
             nsw_priority_science_input, direct_events_science_input, ancillary_input_1,
             ancillary_input_2,
        ...
        expected_download_lo_sw_priority_science_path = data_dir / expected_lo_sw_priority_science_file_download_path
        expected_download_lo_nsw_priority_science_path = data_dir / expected_lo_nsw_priority_science_file_download_path
        ...
        mock_utils_download.assert_has_calls([
            ...
            call(expected_download_lo_sw_priority_science_path),
            call(expected_download_lo_nsw_priority_science_path),
        ...
        mock_from_file_paths.assert_called_with(expected_download_lo_sw_priority_science_path,
                                                expected_download_lo_nsw_priority_science_path,
                                                expected_download_sectored_science_path,
    ...
    @patch('imap_l3_processing.codice.l3.lo.codice_lo_l3a_dependencies.CodiceLoL1aSWPriorityRates.read_from_cdf')
    @patch('imap_l3_processing.codice.l3.lo.codice_lo_l3a_dependencies.CodiceLoL1aNSWPriorityRates.read_from_cdf')
    def test_from_file_paths(self, mock_codice_lo_l1a_nsw_priority_rates, mock_codice_lo_l1a_sw_priority_rates,
                             mock_mass_coefficient_lookup, mock_mpc_read_from_file,
                             mock_read_from_cdf, mock_direct_event_read_from_cdf):
        actual_dependencies = CodiceLoL3aDependencies.from_file_paths(
