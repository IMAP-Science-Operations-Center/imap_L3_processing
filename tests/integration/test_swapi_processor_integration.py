...
class SwapiProcessorIntegration(unittest.TestCase):
    ...
    def test_pui_he_with_production_data(self):
        ...
        expected_values = {
            ...
            'pui_cooling_index': 1.9210189580917358,
            'pui_cooling_index_uncert': 0.20520396530628204,
            'pui_ionization_rate': 7.739931362493735e-08,
            'pui_ionization_rate_uncert': 4.018884780521148e-09,
            'pui_cutoff_speed': 484.36669921875,
            'pui_cutoff_speed_uncert': 3.2249090671539307,
            'pui_background_count_rate': 0.501121461391449,
            'pui_background_count_rate_uncert': 0.19765393435955048,
            'pui_density': 0.000536100473254919,
            'pui_density_uncert': 2.7836513254442252e-05,
            'pui_temperature': 21171528.0,
            'pui_temperature_uncert': 1065450.25,
            'swp_flags': 0,
        }
