...
class TestMapIntegration(unittest.TestCase):
    ...
    def test_ultra_all_sp_maps(self, mock_parse_cli_arguments):
        ...
        input_files = [
            ultra_test_data_dir / 'imap_glows_l3e_survival-probability-ul_20250415-repoint00001_v001.cdf',
            ultra_test_data_dir / 'imap_glows_l3e_survival-probability-ul_20261020-repoint00100_v001.cdf',
            ultra_test_data_dir / 'imap_ultra_l1c_45sensor-spacecraftpset_20250415-repoint00001_v001.cdf',
