...
class TestModels(unittest.TestCase):
    ...
    def test_spectral_index_to_data_products(self):
        ...
        expected_variables = [
            ...
            DataProductVariable(models.ENERGY_DELTAS_VAR_NAME, energy_deltas, cdf_data_type=pycdf.const.CDF_DOUBLE,
                                record_varying=False),
            DataProductVariable(models.INTENSITY_VAR_NAME, flux, cdf_data_type=pycdf.const.CDF_DOUBLE),
    ...
    def test_survival_probability_to_data_product_variables(self):
        ...
        expected_variables = [
            ...
            DataProductVariable(models.INTENSITY_VAR_NAME, flux),
            ...
            DataProductVariable(models.ENERGY_LABEL_VAR_NAME, [f"Energy Bin {e}" for e in energy]),
