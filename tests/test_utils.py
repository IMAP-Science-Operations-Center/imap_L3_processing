...
class TestUtils(TestCase):
    ...
    def test_save_data(self, mock_science_file_path_class, mock_write_cdf, mock_today, mock_attribute_manager):
        ...
        data_product = SwapiL3AlphaSolarWindData(input_metadata=input_metadata, epoch=epoch,
                                                 ...
                                                 alpha_sw_velocity_gse=np.zeros((3, 3)),
                                                 alpha_sw_velocity_gse_covariance=np.zeros((3, 3, 3)),
                                                 alpha_sw_velocity_gsm_sun=np.zeros((3, 3)),
                                                 alpha_sw_velocity_gsm=np.zeros((3, 3)),
                                                 alpha_sw_velocity_gsm_covariance=np.zeros((3, 3, 3)),
                                                 alpha_sw_velocity_hae_sun=np.zeros((3, 3)),
                                                 alpha_sw_velocity_hae=np.zeros((3, 3)),
                                                 alpha_sw_velocity_hae_covariance=np.zeros((3, 3, 3)),
