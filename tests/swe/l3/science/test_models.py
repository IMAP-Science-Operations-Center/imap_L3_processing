...
class TestModels(CdfModelTestCase):
    def test_data_to_product_variables(self):
        ...
        self.assert_variable_attributes(
            next(variables), energy_spectrum, PHASE_SPACE_DENSITY_1D_CDF_VAR_NAME)
        self.assert_variable_attributes(
            next(variables), energy_spectrum_inbound, PHASE_SPACE_DENSITY_INWARD_CDF_VAR_NAME)
        self.assert_variable_attributes(
            next(variables), energy_spectrum_outbound, PHASE_SPACE_DENSITY_OUTWARD_CDF_VAR_NAME)
        self.assert_variable_attributes(
