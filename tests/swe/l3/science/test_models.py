...
from imap_l3_processing.swe.l3.models import SweL3Data, EPOCH_CDF_VAR_NAME, EPOCH_DELTA_CDF_VAR_NAME, \
    ...
    TEMPERATURE_TENSOR_LABEL, INTEGRATED_LABEL, CORE_T_PERPENDICULAR_RATIO_INTEGRATED_CDF_VAR_NAME, \
    ...
    TOTAL_TEMPERATURE_RATIO_PERPENDICULAR_TO_MAG_CDF_VAR_NAME, TENSOR_ID_LABEL
