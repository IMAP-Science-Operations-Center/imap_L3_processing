...
from imap_l3_processing.ultra.ultra_l3_to_rectangular_dependencies import UltraL3ToRectangularDependencies


class TestUltraL3ToRectangularDependencies(unittest.TestCase):

    @patch('imap_l3_processing.ultra.ultra_l3_to_rectangular_dependencies.HealPixIntensityMapData.read_from_path')
    @patch('imap_l3_processing.ultra.ultra_l3_to_rectangular_dependencies.download')
