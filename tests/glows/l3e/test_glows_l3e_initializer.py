...
class TestGlowsL3EInitializer(unittest.TestCase):
    ...
    @patch('imap_l3_processing.glows.l3e.glows_l3e_initializer.identify_versions_for_l3e_output_files')
    ...
    def test_get_repointings_to_process(self, mock_query, mock_get_most_recently_uploaded_ancillary,
        ...
        mock_identify_versions_for_l3e_output_files.assert_called_once_with(2089, 2091, 2090, repointing_file_path, input_major_version)
    ...
    def test_get_repointings_to_process_handles_no_previous_l3d(self, mock_find_first_updated_cr,
        ...
        mock_identify_versions_for_l3e_output_files.assert_called_once_with(2089, 2091, 2089, repointing_file_path, sentinel.version_map)
