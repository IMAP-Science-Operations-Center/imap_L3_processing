...
class TestGlowsL3EDependencies(unittest.TestCase):
    ...
    def test_fetch_dependencies(self, mock_download_dependency_from_path):
        mock_processing_input_collection = Mock()

        mock_l3d = Path('l3d_sdc_path')
        mock_energy_grid_lo = Path('energy_grid_lo_sdc_path')
        ...
        mock_tess_ang16 = Path('tess_ang16_sdc_path')
        ...
        mock_processing_input_collection.get_file_paths.side_effect = [[mock_l3d], [mock_energy_grid_lo],
                                                                       [mock_energy_grid_hi],
        ...
        mock_download_dependency_from_path.assert_has_calls([
            call('l3d_sdc_path'),
            call('energy_grid_lo_sdc_path'),
            call('energy_grid_hi_sdc_path'),
            call('energy_grid_ultra_sdc_path'),
            call('tess_xyz_8_sdc_path'),
            call('tess_ang16_sdc_path'),
            call('lya_series_sdc_path'),
            ...
            call('l3e_pipeline_settings.json'),
        ])
        ...
        self.assertEqual(actual_dependencies.energy_grid_ultra, mock_energy_grid_ultra_path)
        self.assertEqual(actual_dependencies.tess_xyz_8, mock_tess_xyz_8_path)
        self.assertEqual(actual_dependencies.tess_ang16, mock_tess_ang16_path)
