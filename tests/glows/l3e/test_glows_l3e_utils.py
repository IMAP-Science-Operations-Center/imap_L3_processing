...
class TestGlowsL3EUtils(unittest.TestCase):
    ...
    def test_determine_call_args_for_l3e_executable(self, mock_pxform: Mock, mock_reclat: Mock, mock_spkezr: Mock,
        ...
        epoch = datetime.fromisoformat("2025-05-01T12:00:00")
        ...
        elongation = 90
        call_args = determine_call_args_for_l3e_executable(epoch, elongation)

        mock_date_time_2et.assert_called_once_with(epoch)
        ...
        self.assertEqual(
            f"20250501_120000 2025.33014 0.4679210985587912 261.6337638953414 51.56620156177409 {vx} {vy} {vz} 351.3801892514359 20.0000 90.000",
            call_args)
