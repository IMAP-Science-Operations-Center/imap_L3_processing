...
class TestGlowsL3DDependencies(unittest.TestCase):
    ...
    def test_fetch_dependencies(self, mock_download, mock_zip_file_class):
        ...
        mock_processing_input_collection.get_file_paths.assert_has_calls([
            ...
            call(source='glows', descriptor='solar-params-history'),  # L3d descriptor TBD
        ])
        ...
        self.assertEqual(l3d_local_path, actual_dependencies.l3d_path)
    ...
    @patch('imap_l3_processing.glows.l3d.glows_l3d_dependencies.ZipFile')
    @patch('imap_l3_processing.glows.l3d.glows_l3d_dependencies.download')
    def test_fetch_dependencies_no_l3d(self, mock_download: Mock, mock_zip_file_class):
        mock_processing_input_collection = Mock(spec=ProcessingInputCollection)
        ...
        self.assertEqual(8, mock_download.call_count)

        self.assertIsNone(actual_dependencies.l3d_path)
