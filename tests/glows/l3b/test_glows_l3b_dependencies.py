...
from imap_l3_processing.glows.l3b.glows_l3b_dependencies import GlowsInitializerDependencies, F107_FLUX_TABLE_URL, \
...
class TestGlowsL3BDependencies(unittest.TestCase):
    ...
    def test_fetch_dependencies(self, mock_download_external_dependency, mock_download_dependency, mock_cdf_class,
        ...
        actual_dependencies = GlowsInitializerDependencies.fetch_dependencies(
            [l3a_glows_dependency, l3a_swapi_dependency])
        self.assertIsInstance(actual_dependencies, GlowsInitializerDependencies)
