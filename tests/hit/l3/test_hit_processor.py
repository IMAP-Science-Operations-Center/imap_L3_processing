...
class TestHitProcessor(TestCase):
    ...
    @patch('imap_processing.hit.l3.hit_processor.calculate_average_mag_data')
    ...
    def test_can_fetch_dependencies(self, mock_rebin_by_pitch_angle_and_gyrophase, mock_calculate_gyrophase,
                                    ...
                                    mock_calculate_average_mag_data,
        ...
        mock_calculate_average_mag_data.return_value = averaged_mag_vectors
        ...
        mock_get_hit_bin_polar_coordinates.return_value = (sentinel.dec, sentinel.dec_delta, sentinel.inc, sentinel.inc_delta)
        ...
        mock_calculate_average_mag_data.assert_called_once_with(mock_mag_data.mag_data, mock_mag_data.epoch, mock_hit_data.epoch, mock_hit_data.epoch_delta)
