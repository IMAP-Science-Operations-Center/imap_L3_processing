...
class TestModels(CdfModelTestCase):
    ...
    def test_direct_events_to_data_product_variables_with_multiple_events(self):
        ...
        expected_variables = [
            ...
            DataProductVariable(models.DETECTED_RANGE_VAR_NAME, detected_range, cdf_data_type=pycdf.const.CDF_INT1),
            DataProductVariable(models.PARTICLE_ID_VAR_NAME, particle, cdf_data_type=pycdf.const.CDF_INT2),
            DataProductVariable(models.PRIORITY_BUFFER_NUMBER_VAR_NAME, priority_buffer_number,
                                cdf_data_type=pycdf.const.CDF_INT1),
