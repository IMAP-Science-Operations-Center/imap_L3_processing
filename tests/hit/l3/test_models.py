    ...
    def test_direct_events_to_data_product_variables_with_multiple_events(self):
        ...
        expected_variables = [
            ...
            DataProductVariable(models.EPINDEX_VAR_NAME, epindex,
                                cdf_data_type=pycdf.const.CDF_UINT2),
            DataProductVariable(models.STIM_GAIN_VAR_NAME, stim_gain, cdf_data_type=pycdf.const.CDF_UINT1),
            DataProductVariable(models.A_L_STIM_VAR_NAME, a_l_stim, cdf_data_type=pycdf.const.CDF_UINT1),
