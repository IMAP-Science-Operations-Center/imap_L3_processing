...
class TestProcessor(unittest.TestCase):
    @patch("imap_l3_processing.processor.get_spice_parent_file_names")
    def test_get_parent_file_names(self, mock_get_spice_parent_file_names):
        ...
        mock_get_spice_parent_file_names.return_value = ["kernel_1", "kernel_2"]
