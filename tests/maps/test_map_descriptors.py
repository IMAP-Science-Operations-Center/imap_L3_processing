    ...
    def test_parse_map_descriptor(self):
        ...
        test_cases = [
            ...
            ("l090-ena-h-hk-sp-ram-hae-4deg-1yr", MapDescriptorParts(Sensor.Lo90, ReferenceFrame.HeliosphericKinematic,
                                                                     ...
                                                                     MapQuantity.Intensity, "")),
            ("l075-ena-h-hk-sp-ram-hae-4deg-1yr", MapDescriptorParts(Sensor.Lo75, ReferenceFrame.HeliosphericKinematic,
                                                                     sp, SpinPhase.RamOnly, "hae",
                                                                     PixelSize.FourDegrees, "1yr",
                                                                     MapQuantity.Intensity, "")),
            ("l105-ena-h-hk-sp-ram-hae-4deg-1yr", MapDescriptorParts(Sensor.Lo105, ReferenceFrame.HeliosphericKinematic,
                                                                     sp, SpinPhase.RamOnly, "hae",
                                                                     PixelSize.FourDegrees, "1yr",
                                                                     MapQuantity.Intensity, "")),
