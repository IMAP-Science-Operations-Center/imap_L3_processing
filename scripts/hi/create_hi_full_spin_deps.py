...
def create_hi_full_spin_deps(
        ...
        l2_map_dir: Path = get_test_instrument_team_data_path("hi/hi90-6months"),
        glows_dir: Path = get_test_data_path("hi/fake_l3e_survival_probabilities/90")):
    ...
    ram_logical_source = "imap_hi_l3_h90-sf-ram-hae-4deg-6mo_20250415_v001"
    ...
    antiram_logical_source = "imap_hi_l3_h90-sf-anti-hae-4deg-6mo_20250415_v001"
