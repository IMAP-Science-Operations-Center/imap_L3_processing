...
from imap_processing.processor import Processor, format_time
...
class HITL3Processor(Processor):
    def process(self):
        ...
        imap_data_access.query(instrument=l2_data_dependency.instrument, data_level=l2_data_dependency.data_level,
                               descriptor=l2_data_dependency.descriptor, start_date=format_time(self.start_date),
                               end_date=format_time(self.end_date), version="latest")
        ...
        imap_data_access.query(instrument=l2_mag_dependency.instrument, data_level=l2_mag_dependency.data_level,
                               descriptor=l2_mag_dependency.descriptor, start_date=format_time(self.start_date),
                               end_date=format_time(self.end_date), version="latest")
