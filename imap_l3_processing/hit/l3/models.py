...
class HitDirectEventDataProduct(DataProduct):
    ...
    def to_data_product_variables(self) -> list[DataProductVariable]:
        return [
            ...
            DataProductVariable(DETECTED_RANGE_VAR_NAME, self.detected_range, cdf_data_type=pycdf.const.CDF_INT1),
            DataProductVariable(PARTICLE_ID_VAR_NAME, self.particle_id, cdf_data_type=pycdf.const.CDF_INT2),
