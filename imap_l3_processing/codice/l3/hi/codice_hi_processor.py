...
class CodiceHiProcessor(Processor):
    ...
    def process_l3b(self, dependencies: CodicePitchAngleDependencies) -> CodiceHiL3PitchAngleDataProduct:
        ...
        sector_vectors_elevation_by_spin = get_sector_unit_vectors(sectored_intensities.elevation_angle, spin_angles_in_dps_elevation_by_spin_angle)
        sector_unit_vectors = calculate_unit_vector(sector_vectors_elevation_by_spin)
        particle_unit_vectors = -1 * sector_unit_vectors.transpose(1,0,2)
