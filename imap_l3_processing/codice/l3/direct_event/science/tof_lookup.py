...
EnergyPerNuc = namedtuple("EnergyPerNuc", ["energy", "lower_bound", "upper_bound"])
...
class TOFLookup:
    ...
    def read_from_file(cls, filename):
        with open(filename, 'r') as f:
            ...
            energy_per_nuc_dictionary = {tof_bit: EnergyPerNuc(energy, lower_bound, upper_bound)
                                         for tof_bit, (energy, lower_bound, upper_bound)
