...
class CodiceLoL3a3dDistributionsDependencies:
    ...
    def from_file_paths(cls, l3a_file_path: Path, l1a_sw_file_path: Path, l1a_nsw_file_path: Path,
                        mass_species_bin_lut: Path, geometric_factors_lut: Path, efficiency_factors_lut: Path):
        mass_species_bin_lookup = MassSpeciesBinLookup.read_from_csv(mass_species_bin_lut)
        return cls(l3a_direct_event_data=CodiceLoDirectEventData.read_from_cdf(l3a_file_path),
                   ...
                   efficiency_factors_lut=EfficiencyLookup.read_from_zip(efficiency_factors_lut,
                                                                         mass_species_bin_lookup),
                   )
