...
P0_ENERGY_PER_NUC_LOWER_VAR_NAME = "p0_energy_per_nuc_lower"
P0_ENERGY_PER_NUC_VAR_NAME = "p0_energy_per_nuc"
P0_ENERGY_PER_NUC_UPPER_VAR_NAME = "p0_energy_per_nuc_upper"
P0_ESTIMATED_MASS_LOWER_VAR_NAME = "p0_estimated_mass_lower"
P0_ESTIMATED_MASS_VAR_NAME = "p0_estimated_mass"
P0_ESTIMATED_MASS_UPPER_VAR_NAME = "p0_estimated_mass_upper"
...
P1_ENERGY_PER_NUC_LOWER_VAR_NAME = "p1_energy_per_nuc_lower"
P1_ENERGY_PER_NUC_VAR_NAME = "p1_energy_per_nuc"
P1_ENERGY_PER_NUC_UPPER_VAR_NAME = "p1_energy_per_nuc_upper"
P1_ESTIMATED_MASS_LOWER_VAR_NAME = "p1_estimated_mass_lower"
P1_ESTIMATED_MASS_VAR_NAME = "p1_estimated_mass"
P1_ESTIMATED_MASS_UPPER_VAR_NAME = "p1_estimated_mass_upper"
...
P2_ENERGY_PER_NUC_LOWER_VAR_NAME = "p2_energy_per_nuc_lower"
P2_ENERGY_PER_NUC_VAR_NAME = "p2_energy_per_nuc"
P2_ENERGY_PER_NUC_UPPER_VAR_NAME = "p2_energy_per_nuc_upper"
P2_ESTIMATED_MASS_LOWER_VAR_NAME = "p2_estimated_mass_lower"
P2_ESTIMATED_MASS_VAR_NAME = "p2_estimated_mass"
P2_ESTIMATED_MASS_UPPER_VAR_NAME = "p2_estimated_mass_upper"
...
P3_ENERGY_PER_NUC_LOWER_VAR_NAME = "p3_energy_per_nuc_lower"
P3_ENERGY_PER_NUC_VAR_NAME = "p3_energy_per_nuc"
P3_ENERGY_PER_NUC_UPPER_VAR_NAME = "p3_energy_per_nuc_upper"
P3_ESTIMATED_MASS_LOWER_VAR_NAME = "p3_estimated_mass_lower"
P3_ESTIMATED_MASS_VAR_NAME = "p3_estimated_mass"
P3_ESTIMATED_MASS_UPPER_VAR_NAME = "p3_estimated_mass_upper"
...
P4_ENERGY_PER_NUC_LOWER_VAR_NAME = "p4_energy_per_nuc_lower"
P4_ENERGY_PER_NUC_VAR_NAME = "p4_energy_per_nuc"
P4_ENERGY_PER_NUC_UPPER_VAR_NAME = "p4_energy_per_nuc_upper"
P4_ESTIMATED_MASS_LOWER_VAR_NAME = "p4_estimated_mass_lower"
P4_ESTIMATED_MASS_VAR_NAME = "p4_estimated_mass"
P4_ESTIMATED_MASS_UPPER_VAR_NAME = "p4_estimated_mass_upper"
...
P5_ENERGY_PER_NUC_LOWER_VAR_NAME = "p5_energy_per_nuc_lower"
P5_ENERGY_PER_NUC_VAR_NAME = "p5_energy_per_nuc"
P5_ENERGY_PER_NUC_UPPER_VAR_NAME = "p5_energy_per_nuc_upper"
P5_ESTIMATED_MASS_LOWER_VAR_NAME = "p5_estimated_mass_lower"
P5_ESTIMATED_MASS_VAR_NAME = "p5_estimated_mass"
P5_ESTIMATED_MASS_UPPER_VAR_NAME = "p5_estimated_mass_upper"
...
class CodiceL3HiDirectEvents(DataProduct):
    ...
    def to_data_product_variables(self) -> list[DataProductVariable]:
        return [
            ...
            DataProductVariable(P0_ENERGY_PER_NUC_LOWER_VAR_NAME, self.p0_energy_per_nuc_lower),
            DataProductVariable(P0_ENERGY_PER_NUC_VAR_NAME, self.p0_energy_per_nuc),
            DataProductVariable(P0_ENERGY_PER_NUC_UPPER_VAR_NAME, self.p0_energy_per_nuc_upper),
            DataProductVariable(P0_ESTIMATED_MASS_LOWER_VAR_NAME, self.p0_estimated_mass_lower),
            DataProductVariable(P0_ESTIMATED_MASS_VAR_NAME, self.p0_estimated_mass),
            DataProductVariable(P0_ESTIMATED_MASS_UPPER_VAR_NAME, self.p0_estimated_mass_upper),
            ...
            DataProductVariable(P1_ENERGY_PER_NUC_LOWER_VAR_NAME, self.p1_energy_per_nuc_lower),
            DataProductVariable(P1_ENERGY_PER_NUC_VAR_NAME, self.p1_energy_per_nuc),
            DataProductVariable(P1_ENERGY_PER_NUC_UPPER_VAR_NAME, self.p1_energy_per_nuc_upper),
            DataProductVariable(P1_ESTIMATED_MASS_LOWER_VAR_NAME, self.p1_estimated_mass_lower),
            DataProductVariable(P1_ESTIMATED_MASS_VAR_NAME, self.p1_estimated_mass),
            DataProductVariable(P1_ESTIMATED_MASS_UPPER_VAR_NAME, self.p1_estimated_mass_upper),
            ...
            DataProductVariable(P2_ENERGY_PER_NUC_LOWER_VAR_NAME, self.p2_energy_per_nuc_lower),
            DataProductVariable(P2_ENERGY_PER_NUC_VAR_NAME, self.p2_energy_per_nuc),
            DataProductVariable(P2_ENERGY_PER_NUC_UPPER_VAR_NAME, self.p2_energy_per_nuc_upper),
            DataProductVariable(P2_ESTIMATED_MASS_LOWER_VAR_NAME, self.p2_estimated_mass_lower),
            DataProductVariable(P2_ESTIMATED_MASS_VAR_NAME, self.p2_estimated_mass),
            DataProductVariable(P2_ESTIMATED_MASS_UPPER_VAR_NAME, self.p2_estimated_mass_upper),
            ...
            DataProductVariable(P3_ENERGY_PER_NUC_LOWER_VAR_NAME, self.p3_energy_per_nuc_lower),
            DataProductVariable(P3_ENERGY_PER_NUC_VAR_NAME, self.p3_energy_per_nuc),
            DataProductVariable(P3_ENERGY_PER_NUC_UPPER_VAR_NAME, self.p3_energy_per_nuc_upper),
            DataProductVariable(P3_ESTIMATED_MASS_LOWER_VAR_NAME, self.p3_estimated_mass_lower),
            DataProductVariable(P3_ESTIMATED_MASS_VAR_NAME, self.p3_estimated_mass),
            DataProductVariable(P3_ESTIMATED_MASS_UPPER_VAR_NAME, self.p3_estimated_mass_upper),
            ...
            DataProductVariable(P4_ENERGY_PER_NUC_LOWER_VAR_NAME, self.p4_energy_per_nuc_lower),
            DataProductVariable(P4_ENERGY_PER_NUC_VAR_NAME, self.p4_energy_per_nuc),
            DataProductVariable(P4_ENERGY_PER_NUC_UPPER_VAR_NAME, self.p4_energy_per_nuc_upper),
            DataProductVariable(P4_ESTIMATED_MASS_LOWER_VAR_NAME, self.p4_estimated_mass_lower),
            DataProductVariable(P4_ESTIMATED_MASS_VAR_NAME, self.p4_estimated_mass),
            DataProductVariable(P4_ESTIMATED_MASS_UPPER_VAR_NAME, self.p4_estimated_mass_upper),
            ...
            DataProductVariable(P5_ENERGY_PER_NUC_LOWER_VAR_NAME, self.p5_energy_per_nuc_lower),
            DataProductVariable(P5_ENERGY_PER_NUC_VAR_NAME, self.p5_energy_per_nuc),
            DataProductVariable(P5_ENERGY_PER_NUC_UPPER_VAR_NAME, self.p5_energy_per_nuc_upper),
            DataProductVariable(P5_ESTIMATED_MASS_LOWER_VAR_NAME, self.p5_estimated_mass_lower),
            DataProductVariable(P5_ESTIMATED_MASS_VAR_NAME, self.p5_estimated_mass),
            DataProductVariable(P5_ESTIMATED_MASS_UPPER_VAR_NAME, self.p5_estimated_mass_upper)
        ]
