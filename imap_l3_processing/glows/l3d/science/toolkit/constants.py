...
VERSION = "2.0" # version of ground processing software
...
ANC_INPUT_FROM_INSTRUMENT_TEAM = {
    ...
    'WawHelioIon' : {
        'speed': 'data_ancillary/imap_glows_plasma-speed-Legendre-2010a_v001.dat',
        'p-dens': 'data_ancillary/imap_glows_proton-density-Legendre-2010a_v001.dat',
        'uv-anis': 'data_ancillary/imap_glows_uv-anisotropy-2010a_v001.dat',
        'phion': 'data_ancillary/imap_glows_photoion-2010a_v001.dat',
        'lya': 'data_ancillary/imap_glows_lya-2010a_v001.dat',
        'e-dens': 'data_ancillary/imap_glows_electron-density-2010a_v001.dat'
    }}
EXT_DEPENDENCIES={
